...
/*   Updated: 2025/03/27 14:35:54 by apple            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int count_total_a_cost(t_size *s, t_stack **stack_a, t_stack **stack_b, int data)
{
    int total_cost;
...
void update_cheapest_num_a_info(t_cost *cheapest_a, t_size *s, t_stack **stack_b, t_stack **stack_a)
{
    t_stack *temp;
    int total_cost;
    int idx;
